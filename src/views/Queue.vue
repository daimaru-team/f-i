...
<div>
    ...
    <v-alert :value="alertUpdateNewDate" type="success" transition="scale-transition" dismissible Color="red">
            ...
            <v-expansion-panel-content v-for="item in display_booking">
                ...
                <template v-slot:header>
                    ...
                    <v-layout justify-end mr-1 @click="disableNotification(panel)">
                        ...
                        <v-icon v-if="item.confirm_status==='0'" medium color="amber">report</v-icon>
                    </v-layout>
                </template>
                                    ...
                                    <div v-if="item.confirm_status==='1'">
                                        <v-tooltip left>
                                            <template v-slot:activator="{ on }">
                                                <v-btn small fab dark right color="light-blue darken-3" v-on="on" class="elevation-10" style="margin-top:10px;" @click="getDataExpansDialog_add_to_garage(item),alert = false">
                                            ...
                                            <v-layout wrap pl-4 pr-4 pb-3 pt-2>
                                                <v-flex xs12 sm12 md12 mt-2>
                                                    <v-layout wrap>
                                                        ...
                                                        <v-btn icon large color="red" @click="findPID(pId)">
