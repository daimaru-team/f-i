...
<v-card width="100%">
                        ...
                        <v-flex md1 xl1 sm1 lg1 xs1 class="grey lighten-3">
                            <v-layout justify-end wrap>
                                <v-flex text-xs-right md12 xl12 sm12 lg12 xs12>
                                    <v-tooltip left>
                                        <template v-slot:activator="{ on }">
                                            <v-btn small fab dark right color="orange accent-3" v-on="on" class="elevation-10" style="margin-top:10px;" @click="dialog_Edit = true,alert = false">
                                ...
                                <v-flex text-xs-right md12 xl12 sm12 lg12 xs12>
                                    <v-tooltip left>
                                        <template v-slot:activator="{ on }">
                                            <v-btn small fab dark right color="blue" v-on="on" class="elevation-10" style="margin-top:10px;" @click="dialog_Timeline = true,getDataExpans(item.W_ID)">
                                    ...
                                    </v-layout> </v-flex> </v-layout> </v-flex> <v-dialog v-model="dialog_confrim" persistent max-width="700px">
    ...
    <v-dialog v-model="dialog_Insert" persistent max-width="700px">
        <v-card>
            <v-card-text>
                <h1 class="text-xs-center">Insert work</h1>
                <h3 class="text-xs-center">F&I GARAGE</h3>
            </v-card-text>
